...
import ms_imac from "../../asset/MEALSAC_imac.gif";
import bb_imac from "../../asset/BEATBAY_imac.gif";
import ah_imac from "../../asset/AH-WHEW_imac.gif";
import pf_imac from "../../asset/PORTFOLIO_imac.gif";
            ...
            <main className="moreInfoSection">
              ...
              <div>
                ...
                <div className="workGif">
                  ...
                  <img
                    src={detailInfo.imacGIF}
                    alt={`${detailInfo.name}_imac`}
                    className="imacGIF"
                  />
                </div>
              </div>
